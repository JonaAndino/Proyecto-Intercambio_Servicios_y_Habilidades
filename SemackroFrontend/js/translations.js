...
const translations = {
                es: {
                    ...
                    'workOrders.filterAll': 'Todas',
                    'workOrders.filterPending': 'Pendiente',
                    'workOrders.filterInProgress': 'En progreso',
                    'workOrders.filterCompleted': 'Completada',
                    'workOrders.filterCancelled': 'Cancelada',
                    'workOrders.month': 'Mes:',
                    'workOrders.clear': 'Limpiar',
                    'workOrders.search': 'Buscar:',
                    'workOrders.searchPlaceholder': 'Buscar por título...',
                    'workOrders.noOrders': 'No hay órdenes de trabajo disponibles',
                    'workOrders.createHint': 'Haz clic en «Nueva Orden» para crear una',
                    'workOrders.applicants': 'postulante(s)',
                    'workOrders.of': 'de',
                    'workOrders.orders': 'órdenes',
                    'workOrders.actionView': 'Ver',
                    'workOrders.actionEdit': 'Editar',
                    'workOrders.actionCancel': 'Cancelar',
                    'workOrders.actionApply': 'Postularme',
                    'workOrders.fullCapacity': 'Cupo lleno',
                    'workOrders.postPending': 'Tu postulación: En revisión',
                    'workOrders.postAccepted': 'Tu postulación: Aceptada ✓',
                    'workOrders.postRejected': 'Tu postulación: No seleccionado',
                    'workOrders.modalCreateTitle': 'Crear nueva orden de trabajo',
                    'workOrders.modalCreateSubtitle': 'Completa la información para crear o editar una orden de trabajo',
                    'workOrders.fieldTitle': 'Título',
                    'workOrders.fieldTitlePlaceholder': 'Ej: instalación eléctrica residencial',
                    'workOrders.fieldDescription': 'Descripción',
                    'workOrders.fieldDescriptionPlaceholder': 'Describe el trabajo a realizar...',
                    'workOrders.fieldLocation': 'Ubicación de obra',
                    'workOrders.fieldStartDate': 'Fecha Inicio',
                    'workOrders.fieldEndDate': 'Fecha Fin',
                    'workOrders.fieldSpecialty': 'Especialidad',
                    'workOrders.fieldSpecialtyPlaceholder': 'Seleccionar especialidad',
                ...
                en: {
                    ...
                    'workOrders.filterAll': 'All',
                    'workOrders.filterPending': 'Pending',
                    'workOrders.filterInProgress': 'In progress',
                    'workOrders.filterCompleted': 'Completed',
                    'workOrders.filterCancelled': 'Cancelled',
                    'workOrders.month': 'Month:',
                    'workOrders.clear': 'Clear',
                    'workOrders.search': 'Search:',
                    'workOrders.searchPlaceholder': 'Search by title...',
                    'workOrders.noOrders': 'No work orders available',
                    'workOrders.createHint': 'Click «New Order» to create one',
                    'workOrders.applicants': 'applicant(s)',
                    'workOrders.of': 'of',
                    'workOrders.orders': 'orders',
                    'workOrders.actionView': 'View',
                    'workOrders.actionEdit': 'Edit',
                    'workOrders.actionCancel': 'Cancel',
                    'workOrders.actionApply': 'Apply',
                    'workOrders.fullCapacity': 'Full capacity',
                    'workOrders.postPending': 'Your application: Under review',
                    'workOrders.postAccepted': 'Your application: Accepted ✓',
                    'workOrders.postRejected': 'Your application: Not selected',
                    'workOrders.modalCreateTitle': 'Create new work order',
                    'workOrders.modalCreateSubtitle': 'Fill in the information to create or edit a work order',
                    'workOrders.fieldTitle': 'Title',
                    'workOrders.fieldTitlePlaceholder': 'E.g.: residential electrical installation',
                    'workOrders.fieldDescription': 'Description',
                    'workOrders.fieldDescriptionPlaceholder': 'Describe the work to be done...',
                    'workOrders.fieldLocation': 'Work location',
                    'workOrders.fieldStartDate': 'Start Date',
                    'workOrders.fieldEndDate': 'End Date',
                    'workOrders.fieldSpecialty': 'Specialty',
                    'workOrders.fieldSpecialtyPlaceholder': 'Select specialty',
