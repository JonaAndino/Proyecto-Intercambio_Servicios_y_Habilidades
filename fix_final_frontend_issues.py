...
# Common setup with smart fallback for CRUD permissions
common_setup = """
            ...
            const MAPEO_AVANZADO = {
                ...
                'VER_METRICAS': { master: 'Administrador', sub: 'Panel de Administración', nombre: 'Ver panel de métricas y reportes', icon: 'mdi:chart-pie', badgeText: 'VER', badgeColor: 'bg-slate-100 text-slate-600 rounded-md' },
                'VER_HISTORIAL_PERSONAL': { master: 'Administrador', sub: 'Panel de Administración', nombre: 'Ver historial de actividades globales', icon: 'mdi:history', badgeText: 'VER', badgeColor: 'bg-slate-100 text-slate-600 rounded-md' },
                
                // Directorio de Usuarios
                'VER_DIRECTORIO': { master: 'Administrador', sub: 'Directorio de Usuarios', nombre: 'Ver listado y tabla del directorio general', icon: 'mdi:account-group-outline', badgeText: 'VER', badgeColor: 'bg-slate-100 text-slate-600 rounded-md' },
                'CREAR_CUENTAS': { master: 'Administrador', sub: 'Directorio de Usuarios', nombre: 'Crear y enrolar nuevas cuentas de usuario', icon: 'mdi:account-plus-outline', badgeText: 'CREAR', badgeColor: 'bg-emerald-50 text-emerald-500 rounded-md' },
                'EDITAR_USUARIOS': { master: 'Administrador', sub: 'Directorio de Usuarios', nombre: 'Editar perfiles y datos de usuarios', icon: 'mdi:account-edit-outline', badgeText: 'EDITAR', badgeColor: 'bg-amber-50 text-amber-500 rounded-md' },
                'MODERAR_USUARIOS': { master: 'Administrador', sub: 'Directorio de Usuarios', nombre: 'Moderar usuarios (Admin General)', icon: 'mdi:shield-account-outline', badgeText: 'BLOQUEAR', badgeColor: 'bg-red-50 text-red-500 rounded-md' },
                'VER_REPORTES_USUARIOS': { master: 'Administrador', sub: 'Directorio de Usuarios', nombre: 'Ver y gestionar usuarios reportados', icon: 'mdi:alert-circle-outline', badgeText: 'VER', badgeColor: 'bg-slate-100 text-slate-600 rounded-md' },
                'BLOQUEAR_REPORTADOS': { master: 'Administrador', sub: 'Directorio de Usuarios', nombre: 'Bloquear usuarios reportados', icon: 'mdi:account-cancel-outline', badgeText: 'BLOQUEAR', badgeColor: 'bg-red-50 text-red-500 rounded-md' },
                
                // Configuraciones del Sistema
                'GESTIONAR_CONFIGURACION': { master: 'Administrador', sub: 'Configuraciones del Sistema', nombre: 'Gestionar configuración general del sistema', icon: 'mdi:cog-outline', badgeText: 'ADMIN', badgeColor: 'bg-purple-50 text-purple-500 rounded-md' },
                'ASIGNAR_ROLES_PERMISOS': { master: 'Administrador', sub: 'Configuraciones del Sistema', nombre: 'Asignar roles y permisos a usuarios', icon: 'mdi:shield-key-outline', badgeText: 'ADMIN', badgeColor: 'bg-purple-50 text-purple-500 rounded-md' },
                'configGenerales:ver': { master: 'Administrador', sub: 'Configuraciones del Sistema', nombre: 'Configuraciones Generales', icon: 'mdi:cogs', badgeText: 'ADMIN', badgeColor: 'bg-purple-50 text-purple-500 rounded-md' },
                'modalidades:ver': { master: 'Administrador', sub: 'Configuraciones del Sistema', nombre: 'Modalidades de Intercambio', icon: 'mdi:swap-horizontal', badgeText: 'ADMIN', badgeColor: 'bg-purple-50 text-purple-500 rounded-md' },
                'categorias:ver': { master: 'Administrador', sub: 'Configuraciones del Sistema', nombre: 'Categorías y Tipos', icon: 'mdi:shape-outline', badgeText: 'ADMIN', badgeColor: 'bg-purple-50 text-purple-500 rounded-md' },
                'variables:ver': { master: 'Administrador', sub: 'Configuraciones del Sistema', nombre: 'Variables de Impacto', icon: 'mdi:chart-line', badgeText: 'ADMIN', badgeColor: 'bg-purple-50 text-purple-500 rounded-md' },
                'motivosBloqueo:ver': { master: 'Administrador', sub: 'Configuraciones del Sistema', nombre: 'Motivos de Bloqueo', icon: 'mdi:block-helper', badgeText: 'ADMIN', badgeColor: 'bg-purple-50 text-purple-500 rounded-md' },
                'rolesPermisos:ver': { master: 'Administrador', sub: 'Configuraciones del Sistema', nombre: 'Gestión de Roles', icon: 'mdi:badge-account-outline', badgeText: 'ADMIN', badgeColor: 'bg-purple-50 text-purple-500 rounded-md' },
                
                // Solicitudes y Verificación
                'VER_SOLICITUDES_VERIFICACION': { master: 'Administrador', sub: 'Solicitudes y Verificación', nombre: 'Ver y validar solicitudes de verificación', icon: 'mdi:check-decagram-outline', badgeText: 'VER', badgeColor: 'bg-slate-100 text-slate-600 rounded-md' },
                'ACEPTAR_INTERCAMBIOS': { master: 'Administrador', sub: 'Solicitudes y Verificación', nombre: 'Aceptar y gestionar intercambios', icon: 'mdi:handshake-outline', badgeText: 'VER', badgeColor: 'bg-slate-100 text-slate-600 rounded-md' }
            };
                ...
                todosLosPermisosDisponibles.forEach(p => {
                    ...
                    if (!map) {
                        ...
                        map = { 
                            ...
                            sub: 'Configuraciones del Sistema', 
                            nombre: p.nombre, 
                            icon: crud.icon, 
                            badgeText: crud.text, 
                ...
                for (const masterName of Object.keys(jerarquia)) {
                    ...
                    for (const subName of Object.keys(subs)) {
                        ...
                        const htmlPermisos = permisosSub.map(p => {
                            ...
                            // BADGES YA VIENEN CON LAS CLASES DEL MAPEO_AVANZADO Y DETERMINAR_CRUD (rounded-md etc)
                            return `
                    ...
                    htmlMaster += `
                        <div class="mb-4 rounded-2xl ${masterBg} border border-slate-200 overflow-hidden transition-all">
                            ...
                            <div class="transition-all ${isMasterOpen ? 'block' : 'hidden'} bg-white border-t border-slate-200">
...
print("Finished fixing frontend issues successfully!")
